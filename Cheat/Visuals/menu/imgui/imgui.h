...
namespace ImGui
{
    ...
    IMGUI_API ImU32         GetColorU32s(const ImVec4& col, float alpha_mul);              // r           // retrieve given style color with style alpha applied and optional extra alpha multiplier, packed as a 32-bit value suitable for ImDrawList
